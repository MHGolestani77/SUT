...
<body class="login">
	<div id="login" class="container">
		...
		<div class="row">
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
				<p>بسیج دانشجویی دانشگاه صنعتی شاهرود</p>
				<!-- <p>سامانه مدیریت اعضا</p> -->
			</div>
		</div>
		<div class="row">
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
				<div class="login rounded">
					<form action="">
						...
						<!-- <div class="alert alert-danger">نام کاربری یا رمز ورود اشتباه است</div> -->
	...
	<script src="assets/js/main.js?t=<?php echo rand()*rand(); ?>"></script>
